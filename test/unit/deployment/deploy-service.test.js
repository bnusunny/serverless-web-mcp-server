// test/unit/deployment/deploy-service.test.js
const { deployApplication, getDeploymentStatus, generateStartupScript } = require('../../../src/deployment/deploy-service');
...
describe('Deployment Service', () => {
  ...
  describe('generateStartupScript', () => {
    test('should return undefined if no backend configuration', () => {
      const params = {
    ...
    test('should return existing startup script if provided', () => {
      const params = {
        ...
        backendConfiguration: {
          ...
          runtime: 'nodejs18.x',
          startupScript: 'custom-bootstrap'
        }
      };
      
      const result = generateStartupScript(params);
      expect(result).toBe('custom-bootstrap');
    });
    
    test('should generate Node.js startup script', () => {
      const params = {
        deploymentType: 'backend',
        projectName: 'test-project',
        projectRoot: '/path/to/project',
    ...
    test('should generate Python startup script', () => {
      const params = {
        deploymentType: 'backend',
        projectName: 'test-project',
        projectRoot: '/path/to/project',
    ...
    test('should generate Ruby startup script', () => {
      const params = {
        deploymentType: 'backend',
        projectName: 'test-project',
        projectRoot: '/path/to/project',
    ...
    test('should throw error for unsupported runtime', () => {
      ...
      expect(() => generateStartupScript(params)).toThrow('Cannot generate startup script for runtime: java11');
    });
  });
